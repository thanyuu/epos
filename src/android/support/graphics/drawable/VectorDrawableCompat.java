...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    private static class VPath {
        ...
        public String NodesToString(PathDataNode[] nodes) {
            ...
            for (int i = 0; i < nodes.length; i++) {
                result = result + nodes[i].type + MapUtils.DEFAULT_KEY_AND_VALUE_SEPARATOR;
    ...
    private static class VFullPath extends VPath {
        float mFillAlpha = DefaultRetryPolicy.DEFAULT_BACKOFF_MULT;
        int mFillColor = 0;
        int mFillRule;
        float mStrokeAlpha = DefaultRetryPolicy.DEFAULT_BACKOFF_MULT;
        int mStrokeColor = 0;
        ...
        private int[] mThemeAttrs;
        float mTrimPathEnd = DefaultRetryPolicy.DEFAULT_BACKOFF_MULT;
