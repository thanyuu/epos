...
public class AppCompatPopupWindow extends PopupWindow {
    ...
    public AppCompatPopupWindow(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0146R.styleable.PopupWindow, defStyleAttr, 0);
        if (a.hasValue(C0146R.styleable.PopupWindow_overlapAnchor)) {
            setSupportOverlapAnchor(a.getBoolean(C0146R.styleable.PopupWindow_overlapAnchor, false));
        }
        setBackgroundDrawable(a.getDrawable(C0146R.styleable.PopupWindow_android_popupBackground));
        a.recycle();
