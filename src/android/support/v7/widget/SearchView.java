...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C01694 implements OnFocusChangeListener {
        C01694() {
        }
    ...
    class C01705 implements OnLayoutChangeListener {
        C01705() {
        }
    ...
    class C01716 implements OnGlobalLayoutListener {
        C01716() {
        }
    ...
    class C01738 implements OnKeyListener {
        C01738() {
        }
    ...
    class C01749 implements OnEditorActionListener {
        C01749() {
        }
    ...
    static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new C01751();
        boolean isIconified;
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0146R.attr.autoCompleteTextViewStyle);
        }
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0146R.attr.searchViewStyle);
    }

    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.mShowImeRunnable = new C01661();
        this.mUpdateDrawableStateRunnable = new C01672();
        this.mReleaseCursorRunnable = new C01683();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C01727();
        this.mTextKeyListener = new C01738();
        this.mOnEditorActionListener = new C01749();
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0146R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater.from(context).inflate(a.getResourceId(C0146R.styleable.SearchView_layout, C0146R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0146R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0146R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0146R.id.search_plate);
        this.mSubmitArea = findViewById(C0146R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0146R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0146R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0146R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0146R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0146R.id.search_mag_icon);
        this.mSearchPlate.setBackgroundDrawable(a.getDrawable(C0146R.styleable.SearchView_queryBackground));
        this.mSubmitArea.setBackgroundDrawable(a.getDrawable(C0146R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0146R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0146R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0146R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0146R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0146R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0146R.styleable.SearchView_searchHintIcon);
        this.mSuggestionRowLayout = a.getResourceId(C0146R.styleable.SearchView_suggestionRowLayout, C0146R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0146R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C01694());
        setIconifiedByDefault(a.getBoolean(C0146R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0146R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0146R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0146R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0146R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0146R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0146R.styleable.SearchView_android_focusable, true));
        a.recycle();
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C01705());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C01716());
    }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0146R.dimen.abc_search_view_preferred_width);
    }
    ...
    private void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0146R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0146R.dimen.abc_dropdownitem_text_padding_left) : 0;
    ...
    private Intent createIntentFromSuggestion(Cursor c, int actionKey, String actionMsg) {
        try {
            ...
            if (data != null) {
                ...
                if (id != null) {
                    data = data + HttpUtils.PATHS_SEPARATOR + Uri.encode(id);
                }
            }
