...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0146R.attr.actionBarSize, 16842841};
    ...
    class C06661 extends ViewPropertyAnimatorListenerAdapter {
        C06661() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C06661();
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0146R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0146R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0146R.id.action_bar));
        }
    }
