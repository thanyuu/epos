...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray ta = context.obtainStyledAttributes(attrs, C0146R.styleable.ButtonBarLayout);
        this.mAllowStacking = ta.getBoolean(C0146R.styleable.ButtonBarLayout_allowStacking, false);
        ta.recycle();
    }
    ...
    private void setStacked(boolean stacked) {
        ...
        View spacer = findViewById(C0146R.id.spacer);
        if (spacer != null) {
