...
public class ListPopupWindow {
    ...
    class C01632 implements Runnable {
        C01632() {
        }
    ...
    class C01643 implements OnItemSelectedListener {
        C01643() {
        }
    ...
    private static class DropDownListView extends ListViewCompat {
        ...
        public DropDownListView(Context context, boolean hijackFocus) {
            super(context, null, C0146R.attr.dropDownListViewStyle);
    ...
    public ListPopupWindow(Context context) {
        this(context, null, C0146R.attr.listPopupWindowStyle);
    }

    public ListPopupWindow(Context context, AttributeSet attrs) {
        this(context, attrs, C0146R.attr.listPopupWindowStyle);
    }
    ...
    public ListPopupWindow(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0146R.styleable.ListPopupWindow, defStyleAttr, defStyleRes);
        this.mDropDownHorizontalOffset = a.getDimensionPixelOffset(C0146R.styleable.ListPopupWindow_android_dropDownHorizontalOffset, 0);
        this.mDropDownVerticalOffset = a.getDimensionPixelOffset(C0146R.styleable.ListPopupWindow_android_dropDownVerticalOffset, 0);
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            this.mShowDropDownRunnable = new C01632();
            ...
            this.mDropDownList.setOnItemSelectedListener(new C01643());
            ...
            if (hintView != null) {
                ...
                hintParams = new LayoutParams(-1, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
