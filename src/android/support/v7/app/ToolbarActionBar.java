...
class ToolbarActionBar extends ActionBar {
    ...
    private final OnMenuItemClickListener mMenuClicker = new C04182();
    private final Runnable mMenuInvalidator = new C01441();
    ...
    class C04182 implements OnMenuItemClickListener {
        C04182() {
        }
...
*/
    ...
    private void ensureListMenuPresenter(Menu menu) {
        if (this.mListMenuPresenter == null && (menu instanceof MenuBuilder)) {
            ...
            this.mListMenuPresenter = new ListMenuPresenter(context2, C0146R.layout.abc_list_menu_item_layout);
