...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C06631();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C06642();
    private boolean mShowingForMode;
    private ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C04193();

    class C04193 implements ViewPropertyAnimatorUpdateListener {
        C04193() {
        }
    ...
    class C06642 extends ViewPropertyAnimatorListenerAdapter {
        C06642() {
        }
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0146R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0146R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0146R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0146R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0146R.styleable.ActionBar, C0146R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0146R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0146R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0146R.attr.actionBarWidgetTheme, outValue, true);
