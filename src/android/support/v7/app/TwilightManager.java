...
class TwilightManager {
    ...
    private void updateState(@NonNull Location location) {
        ...
        calculator.calculateTwilight(now - C0291a.f41j, location.getLatitude(), location.getLongitude());
        ...
        calculator.calculateTwilight(C0291a.f41j + now, location.getLatitude(), location.getLongitude());
