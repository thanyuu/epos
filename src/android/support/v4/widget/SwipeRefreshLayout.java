...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    class C01222 extends Animation {
        C01222() {
        }
    ...
    class C01233 extends Animation {
        C01233() {
        }
    ...
    class C01255 implements AnimationListener {
        C01255() {
        }
    ...
    class C01266 extends Animation {
        C01266() {
        }
    ...
    class C01277 extends Animation {
        C01277() {
        }
    ...
    class C01288 extends Animation {
        C01288() {
        }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        this.mRefreshListener = new C01211();
        this.mAnimateToCorrectPosition = new C01266();
        this.mAnimateToStartPosition = new C01277();
    ...
    private void startScaleUpAnimation(AnimationListener listener) {
        ...
        this.mScaleAnimation = new C01222();
    ...
    private void startScaleDownAnimation(AnimationListener listener) {
        this.mScaleDownAnimation = new C01233();
    ...
    private void startScaleDownReturnToStartAnimation(int from, AnimationListener listener) {
        ...
        this.mScaleDownToStartAnimation = new C01288();
