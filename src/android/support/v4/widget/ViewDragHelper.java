...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new C01291();
    ...
    private final Runnable mSetIdleRunnable = new C01302();
    private int mTouchSlop;
    private int mTrackingEdges;
    private VelocityTracker mVelocityTracker;

    static class C01291 implements Interpolator {
        C01291() {
        }
