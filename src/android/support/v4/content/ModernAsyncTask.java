...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C00321();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C03912();

    static class C00321 implements ThreadFactory {
    ...
    class C03912 extends WorkerRunnable<Params, Result> {
        C03912() {
            super();
        }
