...
public final class RatingCompat implements Parcelable {
    public static final Creator<RatingCompat> CREATOR = new C00571();
    ...
    static class C00571 implements Creator<RatingCompat> {
        C00571() {
        }
    ...
    public static RatingCompat newHeartRating(boolean hasHeart) {
        return new RatingCompat(1, hasHeart ? DefaultRetryPolicy.DEFAULT_BACKOFF_MULT : 0.0f);
    }

    public static RatingCompat newThumbRating(boolean thumbIsUp) {
        return new RatingCompat(2, thumbIsUp ? DefaultRetryPolicy.DEFAULT_BACKOFF_MULT : 0.0f);
    }
