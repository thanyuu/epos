...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C00721();
    ...
    static class C00721 implements Creator<PlaybackStateCompat> {
        C00721() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C00731();
        ...
        static class C00731 implements Creator<CustomAction> {
            C00731() {
            }
