...
class TransportMediatorJellybeanMR2 {
    OnAudioFocusChangeListener mAudioFocusChangeListener = new C00624();
    boolean mAudioFocused;
    final AudioManager mAudioManager;
    final Context mContext;
    boolean mFocused;
    final OnGetPlaybackPositionListener mGetPlaybackPositionListener = new C00635();
    final Intent mIntent;
    final BroadcastReceiver mMediaButtonReceiver = new C00613();
    PendingIntent mPendingIntent;
    int mPlayState = 0;
    final OnPlaybackPositionUpdateListener mPlaybackPositionUpdateListener = new C00646();
    final String mReceiverAction;
    final IntentFilter mReceiverFilter;
    RemoteControlClient mRemoteControl;
    final View mTargetView;
    final TransportMediatorCallback mTransportCallback;
    final OnWindowAttachListener mWindowAttachListener = new C00591();
    final OnWindowFocusChangeListener mWindowFocusListener = new C00602();

    class C00591 implements OnWindowAttachListener {
        C00591() {
        }
    ...
    class C00602 implements OnWindowFocusChangeListener {
        C00602() {
        }
    ...
    class C00613 extends BroadcastReceiver {
        C00613() {
        }
    ...
    class C00624 implements OnAudioFocusChangeListener {
        C00624() {
        }
    ...
    class C00635 implements OnGetPlaybackPositionListener {
        C00635() {
        }
    ...
    class C00646 implements OnPlaybackPositionUpdateListener {
        C00646() {
        }
