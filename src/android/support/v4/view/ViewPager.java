...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C00941();
    ...
    private static final Interpolator sInterpolator = new C00952();
    ...
    private final Runnable mEndScrollRunnable = new C00963();
    ...
    static class C00941 implements Comparator<ItemInfo> {
        C00941() {
        }
    ...
    static class C00952 implements Interpolator {
        C00952() {
        }
    ...
    class C00963 implements Runnable {
        C00963() {
        }
    ...
    class C04064 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C04064());
    }
