...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener {
    ...
    public static class SavedState implements Parcelable {
        public static final Creator<SavedState> CREATOR = new C00111();
        final Bundle mState;

        static class C00111 implements Creator<SavedState> {
            C00111() {
            }
    ...
    class C03861 extends FragmentContainer {
        C03861() {
        }
    ...
    final void setIndex(int index, Fragment parent) {
        this.mIndex = index;
        if (parent != null) {
            this.mWho = parent.mWho + MapUtils.DEFAULT_KEY_AND_VALUE_SEPARATOR + this.mIndex;
        } else {
    ...
    public void dump(String prefix, FileDescriptor fd, PrintWriter writer, String[] args) {
        ...
        if (this.mChildFragmentManager != null) {
            writer.print(prefix);
            writer.println("Child " + this.mChildFragmentManager + MapUtils.DEFAULT_KEY_AND_VALUE_SEPARATOR);
    ...
    void instantiateChildFragmentManager() {
        ...
        this.mChildFragmentManager.attachController(this.mHost, new C03861(), this);
    }
