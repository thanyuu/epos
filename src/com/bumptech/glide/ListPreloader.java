...
public class ListPreloader<T> implements OnScrollListener {
    ...
    class C04361 implements PreloadModelProvider<T> {
        C04361() {
        }
    ...
    class C04372 implements PreloadSizeProvider<T> {
        C04372() {
        }
    ...
    public ListPreloader(int maxPreload) {
        ...
        this.preloadModelProvider = new C04361();
        this.preloadDimensionProvider = new C04372();
