...
public abstract class Downsampler implements BitmapDecoder<InputStream> {
    public static final Downsampler AT_LEAST = new C06701();
    public static final Downsampler AT_MOST = new C06712();
    private static final int MARK_POSITION = 5242880;
    public static final Downsampler NONE = new C06723();
    ...
    static class C06701 extends Downsampler {
        C06701() {
        }
    ...
    static class C06712 extends Downsampler {
        C06712() {
        }
    ...
    static class C06723 extends Downsampler {
        C06723() {
        }
