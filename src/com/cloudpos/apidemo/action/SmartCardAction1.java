...
public class SmartCardAction1 extends ConstantAction {
        ...
        public void run() {
            ...
            while (SmartCardAction1.isRun) {
                ...
                if (SmartCardInterface.event.nEventID == -1) {
                    ...
                    SmartCardAction1.this.mCallback.sendSuccessMsg(String.format("SlotIndex : %d Event : %s", new Object[]{Integer.valueOf(SmartCardInterface.event.nSlotIndex), "Inserted"}));
                } else if (SmartCardInterface.event.nEventID == SmartCardEvent.SMART_CARD_EVENT_REMOVE_CARD) {
                    SmartCardAction1.this.mCallback.sendSuccessMsg(String.format("SlotIndex : %d Event : %s", new Object[]{Integer.valueOf(SmartCardInterface.event.nSlotIndex), "Removed"}));
                }
            }
            SmartCardAction1.isRun = false;
        }
    }

    class C04951 implements DataAction {
        C04951() {
        }
    ...
    class C04962 implements DataAction {
        C04962() {
        }
    ...
    class C04973 implements DataAction {
        C04973() {
        }
    ...
    class C04995 implements DataAction {
        C04995() {
        }
    ...
    public void open(Map<String, Object> param, ActionCallbackImpl callback) {
        ...
        try {
            ...
            new CallBackThread(callback, SmartCardInterface.objPresent).start();
            new CallBackThread(callback, SmartCardInterface.objAbsent).start();
        } catch (Throwable e) {
            e.printStackTrace();
    ...
    public void close(Map<String, Object> param, ActionCallbackImpl callback) {
        setParams(param, callback);
        cancelRequest();
        checkOpenedAndGetData(new C04973());
    }
    ...
    public void powerOn(Map<String, Object> param, ActionCallbackImpl callback) {
        ...
        checkOpenedAndGetData(new DataAction() {
            public int getResult() {
                int result = SmartCardInterface.powerOn(SmartCardAction1.this.handle, arryATR, slotInfo);
                if (result >= 0) {
                    SmartCardAction1.this.mCallback.sendSuccessMsg("Data = " + StringUtility.ByteArrayToString(arryATR, result));
                }
                return result;
            }
        });
    ...
    public void powerOff(Map<String, Object> param, ActionCallbackImpl callback) {
        setParams(param, callback);
        checkOpenedAndGetData(new C04995());
    }
    ...
    public void transmit(Map<String, Object> param, ActionCallbackImpl callback) {
        ...
        checkOpenedAndGetData(new DataAction() {
            public int getResult() {
                int result = SmartCardInterface.transmit(SmartCardAction1.this.handle, arryAPDU, arryResponse);
                if (result >= 0) {
                    SmartCardAction1.this.mCallback.sendSuccessMsg("APDUResponse = " + StringUtility.ByteArrayToString(arryResponse, result));
                }
                return result;
            }
        });
    ...
    public void verify(Map<String, Object> param, ActionCallbackImpl callback) {
        ...
        checkOpenedAndGetData(new DataAction() {
            public int getResult() {
                return SmartCardInterface.verify(SmartCardAction1.this.handle, arryKey);
            }
        });
    }
    ...
    public void read(Map<String, Object> param, ActionCallbackImpl callback) {
        ...
        checkOpenedAndGetData(new DataAction() {
            public int getResult() {
                int result = SmartCardInterface.read(SmartCardAction1.this.handle, 0, arryData, 0);
                if (result >= 0) {
                    SmartCardAction1.this.mCallback.sendSuccessMsg("Read data = " + StringUtility.ByteArrayToString(arryData, result));
                }
                return result;
            }
        });
    ...
    public void write(Map<String, Object> param, ActionCallbackImpl callback) {
        ...
        checkOpenedAndGetData(new DataAction() {
            public int getResult() {
                int result = SmartCardInterface.read(SmartCardAction1.this.handle, 0, arryData, 0);
                if (result >= 0) {
                    SmartCardAction1.this.mCallback.sendSuccessMsg("Written data = " + StringUtility.ByteArrayToString(arryData, result));
                }
                return result;
            }
        });
