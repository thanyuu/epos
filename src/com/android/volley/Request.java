...
public abstract class Request<T> implements Comparable<Request<T>> {
    ...
    public String getCacheKey() {
        return this.mMethod + MapUtils.DEFAULT_KEY_AND_VALUE_SEPARATOR + this.mUrl;
    }
    ...
    private static String createIdentifier(int method, String url) {
        StringBuilder append = new StringBuilder().append("Request:").append(method).append(MapUtils.DEFAULT_KEY_AND_VALUE_SEPARATOR).append(url).append(MapUtils.DEFAULT_KEY_AND_VALUE_SEPARATOR).append(System.currentTimeMillis()).append(MapUtils.DEFAULT_KEY_AND_VALUE_SEPARATOR);
        long j = sCounter;
        sCounter = 1 + j;
