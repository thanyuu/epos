...
public class HorizontalListView extends AdapterView<ListAdapter> {
    ...
    private DataSetObserver mDataObserver = new C01861();
    private int mDisplayOffset = 0;
    private GestureDetector mGesture;
    private int mLeftViewIndex = -1;
    private int mMaxX = ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
    protected int mNextX;
    private OnGestureListener mOnGesture = new C01872();
    ...
    class C01872 extends SimpleOnGestureListener {
        C01872() {
        }
    ...
    class C01883 implements Runnable {
        C01883() {
        }
