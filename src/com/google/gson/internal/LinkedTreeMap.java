...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C02771();
    ...
    static class C02771 implements Comparator<Comparable> {
        C02771() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C05541 extends LinkedTreeMapIterator<Entry<K, V>> {
            C05541() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C05551 extends LinkedTreeMapIterator<K> {
            C05551() {
                super();
            }
