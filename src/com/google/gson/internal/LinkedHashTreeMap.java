...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C02761();
    ...
    static class C02761 implements Comparator<Comparable> {
        C02761() {
        }
    ...
    final class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C05521 extends LinkedTreeMapIterator<Entry<K, V>> {
            C05521() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C05531 extends LinkedTreeMapIterator<K> {
            C05531() {
                super();
            }
