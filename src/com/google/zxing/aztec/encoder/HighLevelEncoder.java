...
public final class HighLevelEncoder {
    ...
    class C02811 implements Comparator<State> {
        C02811() {
        }
    ...
    static {
        ...
        mixedTable[24] = 96;
        mixedTable[25] = 124;
        mixedTable[26] = TransportMediator.KEYCODE_MEDIA_PLAY;
        mixedTable[27] = 127;
    ...
    public BitArray encode() {
        ...
        return ((State) Collections.min(states, new C02811())).toBitArray(this.text);
    }
