        ...
        try {
            ...
            if (tryHarder && image.isRotateSupported()) {
                ...
                if (metadata != null && metadata.containsKey(ResultMetadataType.ORIENTATION)) {
                    orientation = (((Integer) metadata.get(ResultMetadataType.ORIENTATION)).intValue() + 270) % C0291a.f48q;
                }
                ...
                if (points != null) {
                    ...
                    for (int i = 0; i < points.length; i++) {
                        points[i] = new ResultPoint((((float) height) - points[i].getY()) - DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, points[i].getX());
                    }
                }
            } else {
                throw nfe;
                ...
                while (attempt < 2) {
                    ...
                    try {
                        ...
                        if (attempt == 1) {
                            ...
                            if (points != null) {
                                points[0] = new ResultPoint((((float) width) - points[0].getX()) - DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, points[0].getY());
                                points[1] = new ResultPoint((((float) width) - points[1].getX()) - DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, points[1].getY());
                            }
                        }
                        return result;
