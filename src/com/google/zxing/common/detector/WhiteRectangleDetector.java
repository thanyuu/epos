...
public final class WhiteRectangleDetector {
    ...
    private ResultPoint[] centerEdges(ResultPoint y, ResultPoint z, ResultPoint x, ResultPoint t) {
        ...
        if (yi < ((float) this.width) / 2.0f) {
            return new ResultPoint[]{new ResultPoint(ti - DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT + tj), new ResultPoint(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT + zi, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT + zj), new ResultPoint(xi - DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, xj - DefaultRetryPolicy.DEFAULT_BACKOFF_MULT), new ResultPoint(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT + yi, yj - DefaultRetryPolicy.DEFAULT_BACKOFF_MULT)};
        }
        return new ResultPoint[]{new ResultPoint(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT + ti, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT + tj), new ResultPoint(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT + zi, zj - DefaultRetryPolicy.DEFAULT_BACKOFF_MULT), new ResultPoint(xi - DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT + xj), new ResultPoint(yi - DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, yj - DefaultRetryPolicy.DEFAULT_BACKOFF_MULT)};
    }
