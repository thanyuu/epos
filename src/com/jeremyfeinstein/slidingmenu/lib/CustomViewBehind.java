...
public class CustomViewBehind extends ViewGroup {
    ...
    public void setFadeDegree(float degree) {
        if (degree > DefaultRetryPolicy.DEFAULT_BACKOFF_MULT || degree < 0.0f) {
    ...
    public void drawFade(View content, Canvas canvas, float openPercent) {
        if (this.mFadeEnabled) {
            this.mFadePaint.setColor(Color.argb((int) ((this.mFadeDegree * 255.0f) * Math.abs(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT - openPercent)), 0, 0, 0));
            int left = 0;
            int right = 0;
            if (this.mMode == 0) {
    ...
    public void drawSelector(View content, Canvas canvas, float openPercent) {
        if (this.mSelectorEnabled && this.mSelectorDrawable != null && this.mSelectedView != null && ((String) this.mSelectedView.getTag(C0284R.id.selected_view)).equals("CustomViewBehindSelectedView")) {
            canvas.save();
    ...
    public void setSelectedView(View v) {
        if (this.mSelectedView != null) {
            this.mSelectedView.setTag(C0284R.id.selected_view, null);
            this.mSelectedView = null;
        }
        if (v != null && v.getParent() != null) {
            this.mSelectedView = v;
            this.mSelectedView.setTag(C0284R.id.selected_view, "CustomViewBehindSelectedView");
            invalidate();
        }
    }
