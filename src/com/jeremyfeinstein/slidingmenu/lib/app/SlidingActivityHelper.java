...
import com.jeremyfeinstein.slidingmenu.lib.C0284R;
...
public class SlidingActivityHelper {
    ...
    public void onCreate(Bundle savedInstanceState) {
        this.mSlidingMenu = (SlidingMenu) LayoutInflater.from(this.mActivity).inflate(C0284R.layout.slidingmenumain, null);
    }
