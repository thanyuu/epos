...
public class XListView extends ListView implements OnScrollListener {
    ...
    class C02711 implements OnGlobalLayoutListener {
        C02711() {
        }
    ...
    private void initWithContext(Context context) {
        ...
        this.mHeaderViewContent = (RelativeLayout) this.mHeaderView.findViewById(C0258R.id.xlistview_header_content);
        this.mHeaderTimeView = (TextView) this.mHeaderView.findViewById(C0258R.id.xlistview_header_time);
        addHeaderView(this.mHeaderView);
        this.mFooterView = new XListViewFooter(context);
        this.mHeaderView.getViewTreeObserver().addOnGlobalLayoutListener(new C02711());
    }
    ...
    public void setPullLoadEnable(boolean enable) {
        ...
        if (this.mEnablePullLoad) {
            ...
            this.mFooterView.setOnClickListener(new C02722());
            return;
        }
